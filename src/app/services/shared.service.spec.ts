...
describe('SharedService', () => {
  ...
  it('Deve fazer requisição PUT', () => {
    ...
    const response = {
      titulo: 'Donzela',
      urlFoto:
        'https://wp.ufpel.edu.br/empauta/files/2024/03/Foto-2-Divulgacao-Netflix.jpg',
  ...
  it('Deve fazer uma requisição POST para filmes favoritos', () => {
    const response = {
      ...
      titulo: 'Carros',
      urlFoto:
        'https://play-lh.googleusercontent.com/kHt8qbche40zkE6yZwA8IUe5ARINp4PjrJ5mi622GEzQFYWCaGTQDAl58rrRKRKyhnD2=w240-h480-rw',
      dtLancamento: '2006-06-14T03:00:00.000Z',
      descricao:
        'Um carro de corridas chamado Relâmpago McQueen é desviado para Radiator Springs, onde ele encontra o verdadeiro significado da amizade e da família.',
      nota: 7.2,
      urlIMDb:
        'https://www.imdb.com/title/tt0317219/?ref_=nv_sr_srsg_0_tt_8_nm_0_in_0_q_carros',
      genero: 'Animação',
    };
